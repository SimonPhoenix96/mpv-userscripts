...
function downloadWebms()
  ...
  then
    if(bumpWorthy) then
      ...
      -- remove hardcoded drive letter
      print('powershell.exe -file "E' .. scriptPath .. 'webm-scraper.ps1" "https://www.bumpworthy.com/bumps/" "' .. webmDir .. '" "bumpworthy"')
      os.execute('powershell.exe -file "E' .. scriptPath .. 'webm-scraper.ps1" "https://www.bumpworthy.com/bumps/" "' .. webmDir .. '" "bumpworthy"')
    else
      print('powershell.exe -file "E' .. script_path() .. 'webm-scraper.ps1" "' .. webPage .. '" "' .. webmDir .. '" "singlePage"')
      os.execute('powershell.exe -file "E' .. script_path() .. 'webm-scraper.ps1" "' .. webPage .. '" "' .. webmDir .. '" "singlePage"') -- change regex pattern in webm-scraper.ps1 to website other than the chan
    end
  else
    -- what was before: "wget -P " .. webmDir ..  " -nd -nc -r -l 1 -H -D i.4cdn.org -A webm " .. webPage
    os.execute('powershell.exe -file "E' .. script_path() .. 'webm-scraper.ps1" "' .. webPage .. '" "' .. webmDir .. '" "singlePage"')  -- change i.4cdn.org to wtv if you want to use different website, dont axe me
  end
  --
